...
@section('title', 'Create Mock Subject - Admin Panel')
...
<div class="space-y-6">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Add a new subject for mock exam questions</p>
                </div>
    ...
    <!-- Create Subject Form -->
    <form method="POST" action="{{ route('admin.mock-subjects.store') }}" class="bg-white shadow rounded-lg">
        @csrf
        <div class="px-6 py-4 border-b border-gray-200">
        ...
        <div class="px-6 py-4 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required class="block w-full px-3 py-2 border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-colors duration-200 @error('name') border-red-500 @enderror" placeholder="e.g., Mathematics">
                    @error('name')
