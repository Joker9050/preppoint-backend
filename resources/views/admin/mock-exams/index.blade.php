...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        @forelse($exams as $exam)
            <div class="bg-white overflow-hidden shadow rounded-lg hover:shadow-lg transition-shadow duration-200 min-h-[320px] flex flex-col">
                <div class="p-6 flex-1 flex flex-col">
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex items-center space-x-3 flex-1">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-xl font-bold text-gray-900 leading-tight">{{ $exam->name }}</h3>
                                <p class="text-sm text-gray-500 mt-1">{{ $exam->short_name }}</p>
                            </div>
                        </div>
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <div class="flex items-center text-sm text-gray-600">
                            <i class="fas fa-file-alt mr-2 text-gray-400 w-4"></i>
